...
#define STRING_CONFIG_H_AUTHOR "Psycho" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "0.1" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "sickrabbitstudios.com"         // will be shown during bootup in line 2
...
#define TEMP_BED_RESIDENCY_TIME 15  // (seconds)
